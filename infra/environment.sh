...
NEBIUS_TENANT_ID='tenant-e00wvn4sah1015tmqa' #tenant-e00wvn4sah1015tmqa
NEBIUS_PROJECT_ID_REGION1='project-e00z4n1apr009ey875m33n'
NEBIUS_PROJECT_ID_REGION2='project-e01d5vqhpr003sj5jcr1qk'
...
export NEBIUS_BUCKET_NAME="skypilot-demo-gtc$(echo -n "${NEBIUS_TENANT_ID}-${NEBIUS_PROJECT_ID_REGION1}" | md5sum | awk '$0=$1')"
